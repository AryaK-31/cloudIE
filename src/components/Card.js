        ...
        <div className="max-w-sm bg-white shadow flex flex-col">
            ...
            <div className="pl-5 pr-1 h-[45%] w-full flex flex-col justify-center items-start bg-slate-900">
                ...
                <button
                    ...
                    className={`inline-flex items-center lg:px-[5px] lg:py-[3px] 2xl:px-3 2xl:py-2 text-xs 2xl:text-sm font-medium text-center text-white ${props.status
                            ? 'bg-slate-600 cursor-not-allowed'
                            : 'bg-violet-600 hover:bg-pink-600 focus:ring-4 focus:outline-none focus:ring-blue-300'
                        }`}
                >
                    {!props.status ? (

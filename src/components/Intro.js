...
function Intro() {
  ...
  return (
    <>
      {
        window.innerWidth < 850 ? <div id="intro-frame" className='relative h-screen w-full'>
          <video
            id='intro-vid'
            autoPlay
            muted={isMuted}
          ...
          <Link to='/mainpage'>
            <button
              className='live-glow absolute z-10 text-white right-10 border-white border-2 px-8 py-2 hover:bg-white hover:text-black transition-colors duration-300 bottom-10 text-2xl'
            >
              Skip Intro
            </button>
          </Link>
